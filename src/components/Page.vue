          ...
          <div class="search">
            <div class="search-form">
              ...
              <div class="search-form__button">
                <div>
                <span>
                  <button type="button" class="search-form__button-cal" @click.once="premiumCalculation">
                    <i></i>
                    보험료계산
                  </button>
                </span>
                  <span>
                  <button type="button" class="search-form__button-free" @click.once="freeConsultation">
                    <i></i>
                    무료 상담신청
                  </button>
                </span>
      ...
      if (this.checkValue()) {
        ...
        if (response.data.status) {
          ...
          if (type !== 'premiumCalculation') {
            ...
            this.handlePopupToggle('calculation');
          }
        }
        this.loading = false;
      }
